...
import { SessionEmp } from 'src/models/session_emp.model';

@Injectable()
export class SessionEmpService {
    constructor(@InjectModel('SessionEmp') private readonly Model: Model<SessionEmp>) { }
